...
** Parameters
  ...
  \end{align*}
** Energy
#+ATTR_ORG: :align center :width 1000px
...
** \(T^*_f = 0.28, \quad N = 501\)
*** Energy
#+ATTR_ORG: :align center :width 1000px
[[../../runs/nvt_cool_sample/plots/N_501_T_0.28/ke.png]]

#+ATTR_ORG: :align center :width 1000px
[[../../runs/nvt_cool_sample/plots/N_501_T_0.28/pe.png]]

#+ATTR_ORG: :align center :width 1000px
[[../../runs/nvt_cool_sample/plots/N_501_T_0.28/te.png]]
*** Temperature
#+ATTR_ORG: :align center :width 1000px
[[../../runs/nvt_cool_sample/plots/N_501_T_0.28/temperature.png]]
*** Pressure
#+ATTR_ORG: :align center :width 1000px
[[../../runs/nvt_cool_sample/plots/N_501_T_0.28/pressure.png]]
*** Average NVT Temperature vs KE
#+ATTR_ORG: :align center :width 1000px
[[../../runs/nvt_cool_sample/plots/N_501_T_0.28/TvsKE.png]]

\begin{align*}
KE = \alpha T ^ m, \quad m = 0.99, \quad \alpha = 749.99
\end{align*}
* NVT Checks
** Coslovich and Pastore RDF Check \(T^*_f = 0.28, \quad N = 501, \quad \rho = 1.655\)
*** \(g_{11}(r)\)
#+ATTR_ORG: :align center :width 1000px
[[../../runs/nvt_cool_sample_rdf/plots/rdf_11.png]]

*** \(g_{12}(r)\)

#+ATTR_ORG: :align center :width 1000px
[[../../runs/nvt_cool_sample_rdf/plots/rdf_12.png]]
*** \(g_{22}(r)\)

#+ATTR_ORG: :align center :width 1000px
[[../../runs/nvt_cool_sample_rdf/plots/rdf_22.png]]
